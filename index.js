...
mailer.extend(app, {
  ...
  // mailer.extend(app, {
  //   from: 'contact@clinicaroua.ro',
  //   host: 'mail.clinicaroua.ro', // hostname
  //   secureConnection: true, // use SSL
  //   port: 465, // port for secure SMTP
  //   transportMethod: 'SMTP', // default is SMTP. Accepts anything that nodemailer accepts
  //   auth: {
  //   user: 'contact@clinicaroua.ro', // gmail id
...
var mailOptions = {
  ...
  subject: `Roua - programare : ${info.nume}`,
  user: {  // data to view template, you can access as - user.name
    name: info.nume,
    phone: info.telefon,
    investigatie: info.departament,
    birthDate : info.dataNasterii,
    sex : info.sex,
    email: info.email,
